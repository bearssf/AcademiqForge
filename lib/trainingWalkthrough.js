...
const TRAINING_PAGE_ANCHORS = {
  ...
  anvil: [
    { selector: '#tw-anvil-feedback-rail', description: 'Right rail — Feedback & Suggestions (upper)' },
    ...
    { selector: '#tw-anvil-scoring-metrics', description: 'Four quality metrics (logic, clarity, evidence, grammar)' },
  ...
  crucible: [
    ...
    { selector: '#crucible-suggestions', description: 'Right rail — Source suggestions (upper)' },
    { selector: '#tw-nav-crucible', description: 'Left nav — The Crucible' },
    { selector: '#tw-sidebar-home', description: 'Left nav footer — Home' },
    { selector: '#tw-sidebar-page-tour', description: 'Left nav footer — Page Tour' },
