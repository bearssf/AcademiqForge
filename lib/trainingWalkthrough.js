...
const TRAINING_PAGE_ANCHORS = {
  dashboard: [
    ...
    { selector: '#tw-portfolio-ideas', description: 'Research ideas and published work tiles' },
  ],
  account: [
  ...
  anvil: [
    ...
    { selector: '#anvil-scoring-panel', description: 'Scoring / feedback header (when visible)' },
    { selector: '#anvil-root', description: 'Main writing workspace' },
  ],
  crucible: [{ selector: '#crucible-root', description: 'Crucible workspace (sources and synthesis)' }],
  foundry: [
  ...
  framework: [{ selector: '#tw-framework-workspace', description: 'Framework placeholder / future outline area' }],
  'billing-subscribe': [
