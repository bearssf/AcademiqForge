...
const TRAINING_PAGE_OPTIONS = [
  ...
  { slug: 'framework', label: 'Research Anatomy' },
...
const TRAINING_PAGE_ANCHORS = {
  dashboard: [
    ...
    { selector: '#tw-nav-framework', description: 'Left nav — Research Anatomy' },
  ...
  framework: [
    ...
    { selector: '#tw-sidebar-home', description: 'Left nav footer — Home' },
    { selector: '#tw-sidebar-page-tour', description: 'Left nav footer — Page Tour' },
    { selector: '#tw-framework-workspace', description: 'Research Anatomy canvas — components and flow' },
  ],
  'billing-subscribe': [
