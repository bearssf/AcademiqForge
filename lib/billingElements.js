...
/**
 * Drop stale incomplete checkouts so applying a promo or changing interval does not leave orphan subs.
 * @param {import('stripe').default} stripe
...
/**
 * @param {import('stripe').default} stripe
 * @param {string | null | undefined} promotionCodeId Stripe promotion_code id (promo_...)
 */
