  ...
  try {
    ...
    if (i >= 0 && j > i) {
      try {
        ...
        throw new Error('The AI returned malformed feedback. Please try again.');
      }
    } else {
      throw new Error('The AI returned malformed feedback. Please try again.');
    }
  }
  if (!Array.isArray(arr)) throw new Error('The AI returned malformed feedback. Please try again.');
  return arr;
}
