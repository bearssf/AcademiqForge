...
function buildPrompt({ draftPlain, sectionTitle, outputLanguage }) {
...
- For categories "grammar", "logic", "clarity", "spelling", and "formatting": you MUST provide a concrete replacement in the "suggestion" field and set "isActionable" to true.
